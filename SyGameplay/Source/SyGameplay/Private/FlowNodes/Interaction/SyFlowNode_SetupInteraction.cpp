#include "FlowNodes/Interaction/SyFlowNode_SetupInteraction.h"

#include "FlowLogChannels.h"
#include "State/Operations/OperationTypes.h" // For Modifier, Source, Params
#include "State/Types/Metadatas/BasicMetadataValueTypes.h" // For FSyBoolValue
