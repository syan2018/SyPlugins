...
#include "State/Types/StateParameterTypes.h" // Needed for FSyStateParams and FSyStateParameterSet
...
struct SYCORE_API FSyStateMetadatas
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SYCORE_API FSyStateCategories
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SYCORE_API FSyLayeredStateContainer
{
	GENERATED_BODY()
