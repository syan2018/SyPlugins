 ...
 */
USTRUCT() // 仍然是 USTRUCT
struct SYSTATESYSTEM_API FSyListParameterBase : public FSyBaseInstancedStruct
{
    GENERATED_BODY()
...
struct SYSTATESYSTEM_API FSyStringListParameter : public FSyListParameterBase
{
    GENERATED_BODY()
