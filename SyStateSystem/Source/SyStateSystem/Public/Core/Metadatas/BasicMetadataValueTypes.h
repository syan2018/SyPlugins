...
struct SYSTATESYSTEM_API FSyBoolValue: public FSyBaseInstancedStruct
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct SYSTATESYSTEM_API FSyIntValue: public FSyBaseInstancedStruct
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct SYSTATESYSTEM_API FSyFloatValue: public FSyBaseInstancedStruct
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct SYSTATESYSTEM_API FSyStringValue: public FSyBaseInstancedStruct
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct SYSTATESYSTEM_API FSyNameValue: public FSyBaseInstancedStruct
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct SYSTATESYSTEM_API FSyVectorValue: public FSyBaseInstancedStruct
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct SYSTATESYSTEM_API FSyRotatorValue: public FSyBaseInstancedStruct
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct SYSTATESYSTEM_API FSyTransformValue: public FSyBaseInstancedStruct
{
    GENERATED_BODY()
