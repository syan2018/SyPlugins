...
#include "Operations/OperationTypes.h" // Needed for FSyOperationSource in new functions
 ...
 */
UCLASS()
class SYSTATESYSTEM_API USyStateManagerSubsystem : public UGameInstanceSubsystem
{
    GENERATED_BODY()
