...
struct SYSTATESYSTEM_API FSyOperationSource
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SYSTATESYSTEM_API FSyOperationTarget
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SYSTATESYSTEM_API FSyOperationModifier
{
    GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SYSTATESYSTEM_API FSyOperation
{
    GENERATED_BODY()
